...
export interface BioPassportVotingInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'IDENTITY_LIMIT'
      | '__BioPassportVoting_init'
      | '_afterVerify'
      | '_beforeVerify'
      | '_buildPublicSignals'
      | 'execute'
  ...
  encodeFunctionData(
    functionFragment: '__BioPassportVoting_init',
  ...
  decodeFunctionResult(functionFragment: '__BioPassportVoting_init', data: BytesLike): Result
...
export interface BioPassportVoting extends BaseContract {
  connect(runner?: ContractRunner | null): BioPassportVoting
  waitForDeployment(): Promise<this>

  interface: BioPassportVotingInterface
  ...
  __BioPassportVoting_init: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: '__BioPassportVoting_init',
  ): TypedContractMethod<
    [registrationSMT_: AddressLike, proposalsState_: AddressLike, votingVerifier_: AddressLike],
    [void],
    'nonpayable'
