...
export const lightPalette = {
  ...
  primaryDarker: '#01578C',
  primaryDark: '#0064A2',
  primaryMain: '#006EB2',
  primaryLight: getRgba('#006EB21A', 0.1),
  primaryLighter: getRgba('#006EB20D', 0.05),
  ...
  textPrimary: '#1F2C43',
  textSecondary: getRgba('#1F2C43', 0.56),
  textPlaceholder: getRgba('#1F2C43', 0.44),
  textDisabled: getRgba('#1F2C43', 0.28),

  componentPrimary: getRgba('#1F2C431A', 0.05),
  componentHovered: getRgba('#2020201A', 0.1),
  componentPressed: getRgba('#2020201A', 0.15),
  componentSelected: getRgba('#2020201A', 0.05),
  componentDisabled: getRgba('#2020201A', 0.05),

  backgroundPrimary: '#F8F9FB',
  backgroundContainer: '#FFFFFF',
  backgroundPure: getRgba('#1F2C430D', 0.05),
...
export const darkPalette: BaseTheme = {
  ...
  primaryDarker: '#2F93D1',
  primaryDark: '#2086C5',
  primaryMain: '#147AB8',
  primaryLight: getRgba('#147AB81A', 0.1),
  primaryLighter: getRgba('#147AB80D', 0.05),
